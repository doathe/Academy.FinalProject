...
namespace ECommerce.Infrastructure.EFCore.Migrations
{
    ...
    [Migration("20230413215201_initMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Domain.AggregateModels.CategoryAggregate.Category", b =>
                {
                    ...
                    b.HasIndex("ParentCategoryId", "Name")
                        .IsUnique()
                        .HasFilter("[main_category_id] IS NOT NULL");

                    b.ToTable("category", "dbo");
                });

            modelBuilder.Entity("ECommerce.Domain.AggregateModels.CategoryAggregate.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("product_category_item", "dbo");
                });
            ...
            modelBuilder.Entity("ECommerce.Domain.AggregateModels.CategoryAggregate.Category", b =>
                {
                    b.HasOne("ECommerce.Domain.AggregateModels.CategoryAggregate.Category", "ParentCategory")
